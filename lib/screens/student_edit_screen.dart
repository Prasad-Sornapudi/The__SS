...
class StudentEditScreen extends StatefulWidget {
  ...
  const StudentEditScreen({super.key, required this.student, required this.classModel});
  ...
  Future<void> _fetchStudentAttendanceDetails() async {
    try {
      ...
      final attendanceRecords = await firebaseService.getStudentAttendanceHistory(
        classId: widget.classModel.sheetName ?? widget.classModel.className,
        studentPinNumber: _student.pinNumber,
        studentCombo: _student.combo,
      );
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    readOnly: true, // Read-only as per requirement
                    decoration: InputDecoration(
                      labelText: 'Branch',
                      filled: true,
                      fillColor: const Color(0xFF040C1B).withOpacity(0.5), // 50% opacity
            ...
            GradientButton(
              onPressedAsync: () async {
                if (_formKey.currentState!.validate()) {
                  ...
                  // This ensures the previous screen (ClassDetailsScreen) shows updated data
                  ...
                  // This ensures the current screen shows updated data
                  setState(() {
